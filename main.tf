...
module "label" {
  source     = "git::https://github.com/github/terraform-null-label.git?ref=tags/0.15.0-scalyr"
...
module "autoscale_group" {
  source = "git::https://github.com/github/terraform-aws-ec2-autoscale-group.git?ref=tags/0.4.0-scalyr"
